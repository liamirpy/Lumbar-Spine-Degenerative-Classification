...
class predictior:
    ...
    def Neural_Foraminal_Narrowing(self,study_id,series_id,prediction):
        ...
        condition_detector_model = YOLO("./models/condtion_detector/Neural_Foraminal_Narrowing.pt")


        score_prediction_model = keras.models.load_model("./models/score_predictor/Neural_Foraminal_Narrowing.keras",
    ...
    def Spinal_Canal_Stenosis(self,study_id,series_id,prediction):
        ...
        condition_detector_model = YOLO("./models/condtion_detector/Spinal_Canal_Stenosis.pt")


        score_prediction_model = keras.models.load_model("./models/score_predictor/Spinal_Canal_Stenosis.keras",
    ...
    def Subarticular_Stenosis(self,study_id,series_id,prediction):
        ...
        condition_detector_model = YOLO("./models/condtion_detector/Subarticular_Stenosis.pt")


        score_prediction_model = keras.models.load_model("./models/score_predictor/Subarticular_Stenosis.keras",
...
# {'44036939': {'Left_Subarticular_Stenosis_L1_L2': [0.4998255763636364, 0.40180986818181813, 0.09836457645454547], 
# 'Left_Subarticular_Stenosis_L2_L3': [0.29133872200000005, 0.4493649733333333, 0.25929633333333335], 
# 'Left_Subarticular_Stenosis_L3_L4': [0.28365266033333336, 0.4142148233333333, 0.30213254566666664],
#  'Left_Subarticular_Stenosis_L4_L5': [0.324333705, 0.38671510000000003, 0.288951177], 
#  'Left_Subarticular_Stenosis_L5_S1': [0.5650566866666668, 0.38626585333333335, 0.048677467333333335],
#   'Right_Subarticular_Stenosis_L1_L2': [0.485838652, 0.41297005000000003, 0.101191328], 
#   'Right_Subarticular_Stenosis_L2_L3': [0.50544167, 0.37713793, 0.11742041], 
#   'Right_Subarticular_Stenosis_L3_L4': [0.459427415, 0.38671219, 0.15386036], 
#   'Right_Subarticular_Stenosis_L4_L5': [0.3222759325, 0.42249434750000003, 0.2552296975], 
#   'Right_Subarticular_Stenosis_L5_S1': [0.482632635, 0.39412318749999997, 0.12324421725], 
#   'Left_Neural_Foraminal_Narrowing_L1_L2': [],
#    'Left_Neural_Foraminal_Narrowing_L2_L3': [],
#     'Left_Neural_Foraminal_Narrowing_L3_L4': [0.06646155, 0.34472957, 0.5888089],
#      'Left_Neural_Foraminal_Narrowing_L4_L5': [0.2614578, 0.5653935, 0.17314874],
#       'Left_Neural_Foraminal_Narrowing_L5_S1': [0.385176, 0.5175311, 0.09729294], 
#       'Right_Neural_Foraminal_Narrowing_L1_L2': [], 
#       'Right_Neural_Foraminal_Narrowing_L2_L3': [],
#        'Right_Neural_Foraminal_Narrowing_L3_L4': [], 
#        'Right_Neural_Foraminal_Narrowing_L4_L5': [0.51865935, 0.42116457, 0.060176063],
#         'Right_Neural_Foraminal_Narrowing_L5_S1': [0.56941146, 0.33324042, 0.097348176], 
#         'Spinal_Canal_Stenosis_L1_L2': [0.59454094, 0.33870835333333327, 0.06675074599999999], 
#         'Spinal_Canal_Stenosis_L2_L3': [0.16242258999999998, 0.37944366, 0.45813371999999997],
#          'Spinal_Canal_Stenosis_L3_L4': [0.5436954275, 0.32110091, 0.13520368175], 
#          'Spinal_Canal_Stenosis_L4_L5': [0.41073226675, 0.3776999425, 0.21156780275], 
#          'Spinal_Canal_Stenosis_L5_S1': [0.46786051, 0.45483454666666673, 0.07730494566666667]}}
...
# {'44036939': {'Left_Subarticular_Stenosis_L1_L2': [[0.5580876, 0.42469987, 0.017212477], [0.54367, 0.33097824, 0.12535182], [0.2836033, 0.5252076, 0.1911891], [0.61048806, 0.32136452, 0.068147466], [0.58265406, 0.3721228, 0.045223128], [0.30227992, 0.4747069, 0.22301327], [0.21272701, 0.49448532, 0.2927877], [0.5764287, 0.38313386, 0.040437385], [0.58114105, 0.3865698, 0.032289166], [0.6310535, 0.34976777, 0.019178815], [0.61594814, 0.35687187, 0.027180014]],
#  'Left_Subarticular_Stenosis_L2_L3': [[0.4934402, 0.3835948, 0.12296503], [0.090543486, 0.45112512, 0.45833147], [0.29003248, 0.513375, 0.1965925]], 
#  'Left_Subarticular_Stenosis_L3_L4': [[0.43169117, 0.45046154, 0.11784727], [0.027762957, 0.39517483, 0.5770622], [0.5967957, 0.35130456, 0.051899854], [0.07442579, 0.40550673, 0.5200675], [0.098117985, 0.4587663, 0.44311577], [0.47312236, 0.42407498, 0.10280268]],
#   'Left_Subarticular_Stenosis_L4_L5': [[0.11126637, 0.41072077, 0.47801277], [0.04505941, 0.41873145, 0.5362091], [0.62924004, 0.33599943, 0.034760498], [0.511769, 0.38140875, 0.10682234]],
#    'Left_Subarticular_Stenosis_L5_S1': [[0.5323766, 0.41346958, 0.054153785], [0.56190586, 0.38677618, 0.05131801], [0.6008876, 0.3585518, 0.040560607]], 
#    'Right_Subarticular_Stenosis_L1_L2': [[0.5689144, 0.3835391, 0.047546513], [0.6349444, 0.351556, 0.013499647], [0.21643329, 0.5539855, 0.22958127], [0.6573978, 0.3296752, 0.01292695], [0.35150337, 0.44609445, 0.20240226]], 
#    'Right_Subarticular_Stenosis_L2_L3': [[0.50544167, 0.37713793, 0.11742041]], 
#    'Right_Subarticular_Stenosis_L3_L4': [[0.61107093, 0.32859448, 0.06033461], [0.3077839, 0.4448299, 0.24738611]], 
#    'Right_Subarticular_Stenosis_L4_L5': [[0.49262252, 0.38183156, 0.12554592], [0.34832138, 0.4428846, 0.20879397], [0.30106613, 0.40680933, 0.2921245], [0.1470937, 0.4584519, 0.3944544]],
#     'Right_Subarticular_Stenosis_L5_S1': [[0.6596228, 0.3030851, 0.037292134], [0.38723224, 0.4727307, 0.14003712], [0.57841, 0.331464, 0.090126015], [0.3052655, 0.46921295, 0.2255216]],
#      'Left_Neural_Foraminal_Narrowing_L1_L2': [], 'Left_Neural_Foraminal_Narrowing_L2_L3': [], 'Left_Neural_Foraminal_Narrowing_L3_L4': [[0.06646155, 0.34472957, 0.5888089]], 
#      'Left_Neural_Foraminal_Narrowing_L4_L5': [[0.2614578, 0.5653935, 0.17314874]], 
#      'Left_Neural_Foraminal_Narrowing_L5_S1': [[0.385176, 0.5175311, 0.09729294]], 
#      'Right_Neural_Foraminal_Narrowing_L1_L2': [], 'Right_Neural_Foraminal_Narrowing_L2_L3': [], 
#      'Right_Neural_Foraminal_Narrowing_L3_L4': [], 'Right_Neural_Foraminal_Narrowing_L4_L5': [[0.51865935, 0.42116457, 0.060176063]], 
#      'Right_Neural_Foraminal_Narrowing_L5_S1': [[0.56941146, 0.33324042, 0.097348176]],
#       'Spinal_Canal_Stenosis_L1_L2': [[0.39756748, 0.49233958, 0.11009299], [0.5800507, 0.34366578, 0.07628354], [0.80600464, 0.1801197, 0.013875708]],
#        'Spinal_Canal_Stenosis_L2_L3': [[0.07301798, 0.37653658, 0.55044544], [0.2518272, 0.38235074, 0.365822]], 
#        'Spinal_Canal_Stenosis_L3_L4': [[0.68033665, 0.2841096, 0.035553787], [0.81694835, 0.16379897, 0.01925265], [0.53562, 0.3974621, 0.06691796], [0.14187671, 0.43903297, 0.41909033]],
#         'Spinal_Canal_Stenosis_L4_L5': [[0.7520976, 0.20860788, 0.039294507], [0.517364, 0.39761233, 0.08502363], [0.33818278, 0.55536956, 0.106447734], [0.035284687, 0.34921, 0.61550534]], 
#         'Spinal_Canal_Stenosis_L5_S1': [[0.43357658, 0.49678394, 0.069639534], [0.35786095, 0.5057585, 0.13638051], [0.612144, 0.3619612, 0.025894793]]}}
...
# {'2872240784': {'modality': 'Sagittal_T1', 'condition': 'Neural_Foraminal_Narrowing', 'prediction': []},

#  '3526008457': {'modality': 'Axial_T2', 'condition': 'Subarticular_Stenosis',
#   'prediction': [{'condition': 'Right_Subarticular_Stenosis_L4_L5', 'confident_of_condition': 0.477896124124527, 'score_prediction': array([    0.49262,     0.38183,     0.12555], dtype=float32)},
#                 {'condition': 'Left_Subarticular_Stenosis_L3_L4', 'confident_of_condition': 0.38550207018852234, 'score_prediction': array([    0.43169,     0.45046,     0.11785], dtype=float32)}, 
#                 {'condition': 'Right_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.2567550837993622, 'score_prediction': array([    0.56891,     0.38354,    0.047547], dtype=float32)}, 
#                 {'condition': 'Right_Subarticular_Stenosis_L5_S1', 'confident_of_condition': 0.5985532999038696, 'score_prediction': array([    0.65962,     0.30309,    0.037292], dtype=float32)},
#                 {'condition': 'Left_Subarticular_Stenosis_L5_S1', 'confident_of_condition': 0.4833911657333374, 'score_prediction': array([    0.53238,     0.41347,    0.054154], dtype=float32)}, 
#                 {'condition': 'Left_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.5265852808952332, 'score_prediction': array([    0.55809,      0.4247,    0.017212], dtype=float32)}, 
#                 {'condition': 'Right_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.30948442220687866, 'score_prediction': array([    0.63494,     0.35156,      0.0135], dtype=float32)}, 
#                 {'condition': 'Left_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.28314119577407837, 'score_prediction': array([    0.54367,     0.33098,     0.12535], dtype=float32)}, 
#                 {'condition': 'Left_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.2506023645401001, 'score_prediction': array([     0.2836,     0.52521,     0.19119], dtype=float32)},
#                 {'condition': 'Left_Subarticular_Stenosis_L3_L4', 'confident_of_condition': 0.31786486506462097, 'score_prediction': array([   0.027763,     0.39517,     0.57706], dtype=float32)}, 
#                 {'condition': 'Left_Subarticular_Stenosis_L3_L4', 'confident_of_condition': 0.5419588685035706, 'score_prediction': array([     0.5968,      0.3513,      0.0519], dtype=float32)}, 
#                 {'condition': 'Left_Subarticular_Stenosis_L5_S1', 'confident_of_condition': 0.4901745021343231, 'score_prediction': array([    0.56191,     0.38678,    0.051318], dtype=float32)}, 
#                 {'condition': 'Left_Subarticular_Stenosis_L3_L4', 'confident_of_condition': 0.4412180185317993, 'score_prediction': array([   0.074426,     0.40551,     0.52007], dtype=float32)}, 
#                 {'condition': 'Right_Subarticular_Stenosis_L3_L4', 'confident_of_condition': 0.2657001316547394, 'score_prediction': array([    0.61107,     0.32859,    0.060335], dtype=float32)},
#                 {'condition': 'Left_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.38434311747550964, 'score_prediction': array([    0.61049,     0.32136,    0.068147], dtype=float32)}, 
#                 {'condition': 'Right_Subarticular_Stenosis_L5_S1', 'confident_of_condition': 0.39076027274131775, 'score_prediction': array([    0.38723,     0.47273,     0.14004], dtype=float32)},
#                 {'condition': 'Right_Subarticular_Stenosis_L4_L5', 'confident_of_condition': 0.29849815368652344, 'score_prediction': array([    0.34832,     0.44288,     0.20879], dtype=float32)},
#                 {'condition': 'Left_Subarticular_Stenosis_L2_L3', 'confident_of_condition': 0.42074406147003174, 'score_prediction': array([    0.49344,     0.38359,     0.12297], dtype=float32)},
#                 {'condition': 'Right_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.471079021692276, 'score_prediction': array([    0.21643,     0.55399,     0.22958], dtype=float32)},
#                 {'condition': 'Left_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.36258718371391296, 'score_prediction': array([    0.58265,     0.37212,    0.045223], dtype=float32)},
#                 {'condition': 'Left_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.4119408130645752, 'score_prediction': array([    0.30228,     0.47471,     0.22301], dtype=float32)},
#                 {'condition': 'Right_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.2606167197227478, 'score_prediction': array([     0.6574,     0.32968,    0.012927], dtype=float32)},
#                 {'condition': 'Left_Subarticular_Stenosis_L3_L4', 'confident_of_condition': 0.392037570476532, 'score_prediction': array([   0.098118,     0.45877,     0.44312], dtype=float32)}, 
#                 {'condition': 'Right_Subarticular_Stenosis_L3_L4', 'confident_of_condition': 0.2912525534629822, 'score_prediction': array([    0.30778,     0.44483,     0.24739], dtype=float32)},
#                 {'condition': 'Right_Subarticular_Stenosis_L4_L5', 'confident_of_condition': 0.3783451318740845, 'score_prediction': array([    0.30107,     0.40681,     0.29212], dtype=float32)},
#                 {'condition': 'Left_Subarticular_Stenosis_L4_L5', 'confident_of_condition': 0.33304157853126526, 'score_prediction': array([    0.11127,     0.41072,     0.47801], dtype=float32)}, 
#                 {'condition': 'Right_Subarticular_Stenosis_L5_S1', 'confident_of_condition': 0.493558794260025, 'score_prediction': array([    0.57841,     0.33146,    0.090126], dtype=float32)}, 
#                 {'condition': 'Right_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.5354706645011902, 'score_prediction': array([     0.3515,     0.44609,      0.2024], dtype=float32)}, 
#                 {'condition': 'Left_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.31742244958877563, 'score_prediction': array([    0.21273,     0.49449,     0.29279], dtype=float32)},
#                 {'condition': 'Left_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.2804158926010132, 'score_prediction': array([    0.57643,     0.38313,    0.040437], dtype=float32)}, 
#                 {'condition': 'Left_Subarticular_Stenosis_L2_L3', 'confident_of_condition': 0.7354334592819214, 'score_prediction': array([   0.090543,     0.45113,     0.45833], dtype=float32)},
#                 {'condition': 'Left_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.402029812335968, 'score_prediction': array([    0.58114,     0.38657,    0.032289], dtype=float32)}, 
#                 {'condition': 'Left_Subarticular_Stenosis_L4_L5', 'confident_of_condition': 0.5458420515060425, 'score_prediction': array([   0.045059,     0.41873,     0.53621], dtype=float32)},
#                 {'condition': 'Right_Subarticular_Stenosis_L4_L5', 'confident_of_condition': 0.4013291597366333, 'score_prediction': array([    0.14709,     0.45845,     0.39445], dtype=float32)},
#                 {'condition': 'Left_Subarticular_Stenosis_L4_L5', 'confident_of_condition': 0.29595330357551575, 'score_prediction': array([    0.62924,       0.336,     0.03476], dtype=float32)}, 
#                 {'condition': 'Left_Subarticular_Stenosis_L2_L3', 'confident_of_condition': 0.27071458101272583, 'score_prediction': array([    0.29003,     0.51337,     0.19659], dtype=float32)}, 
#                 {'condition': 'Left_Subarticular_Stenosis_L5_S1', 'confident_of_condition': 0.29917216300964355, 'score_prediction': array([    0.60089,     0.35855,    0.040561], dtype=float32)}, 
#                 {'condition': 'Right_Subarticular_Stenosis_L5_S1', 'confident_of_condition': 0.4749331772327423, 'score_prediction': array([    0.30527,     0.46921,     0.22552], dtype=float32)}, 
#                 {'condition': 'Left_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.3490436375141144, 'score_prediction': array([    0.63105,     0.34977,    0.019179], dtype=float32)}, 
#                 {'condition': 'Right_Subarticular_Stenosis_L2_L3', 'confident_of_condition': 0.6072553992271423, 'score_prediction': array([    0.50544,     0.37714,     0.11742], dtype=float32)}, 
#                 {'condition': 'Left_Subarticular_Stenosis_L4_L5', 'confident_of_condition': 0.5536304116249084, 'score_prediction': array([    0.51177,     0.38141,     0.10682], dtype=float32)},
#                 {'condition': 'Left_Subarticular_Stenosis_L3_L4', 'confident_of_condition': 0.35776713490486145, 'score_prediction': array([    0.47312,     0.42407,      0.1028], dtype=float32)},
#                 {'condition': 'Left_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.356276273727417, 'score_prediction': array([    0.61595,     0.35687,     0.02718], dtype=float32)}]}, 
...
#                                   '3888430028': {'modality': 'Sagittal_T2/STIR', 'condition': 'Spinal_Canal_Stenosis', 'prediction': []}}
...
{'si_44036939_sei_2828203845': {'modality': 'Sagittal_T1', 'condition': 'Neural_Foraminal_Narrowing', 'prediction': [{'condition': 'Left_Neural_Foraminal_Narrowing_L3_L4', 'confident_of_condition': 0.3879946172237396, 'score_prediction': [array([     0.0768,     0.33529,     0.58791], dtype=float32)]}, {'condition': 'Left_Neural_Foraminal_Narrowing_L4_L5', 'confident_of_condition': 0.27843159437179565, 'score_prediction': [array([    0.22473,     0.61178,     0.16349], dtype=float32)]}, {'condition': 'Left_Neural_Foraminal_Narrowing_L5_S1', 'confident_of_condition': 0.3880711793899536, 'score_prediction': [array([    0.42586,     0.49293,    0.081216], dtype=float32)]}, {'condition': 'Left_Neural_Foraminal_Narrowing_L1_L2', 'confident_of_condition': 0.26214665174484253, 'score_prediction': [array([    0.66346,     0.33293,   0.0036071], dtype=float32)]}]}, 'si_44036939_sei_3481971518': {'modality': 'Axial_T2', 'condition': 'Subarticular_Stenosis', 'prediction': [{'condition': 'Right_Subarticular_Stenosis_L4_L5', 'confident_of_condition': 0.477896124124527, 'score_prediction': [array([    0.49262,     0.38183,     0.12555], dtype=float32)]}, {'condition': 'Left_Subarticular_Stenosis_L3_L4', 'confident_of_condition': 0.5419588685035706, 'score_prediction': [array([     0.5968,      0.3513,      0.0519], dtype=float32)]}, {'condition': 'Right_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.5354706645011902, 'score_prediction': [array([     0.3515,     0.44609,      0.2024], dtype=float32)]}, {'condition': 'Right_Subarticular_Stenosis_L5_S1', 'confident_of_condition': 0.5985532999038696, 'score_prediction': [array([    0.65962,     0.30309,    0.037292], dtype=float32)]}, {'condition': 'Left_Subarticular_Stenosis_L5_S1', 'confident_of_condition': 0.4901745021343231, 'score_prediction': [array([    0.56191,     0.38678,    0.051318], dtype=float32)]}, {'condition': 'Left_Subarticular_Stenosis_L1_L2', 'confident_of_condition': 0.5265852808952332, 'score_prediction': [array([    0.55809,      0.4247,    0.017212], dtype=float32)]}, {'condition': 'Right_Subarticular_Stenosis_L3_L4', 'confident_of_condition': 0.2912525534629822, 'score_prediction': [array([    0.30778,     0.44483,     0.24739], dtype=float32)]}, {'condition': 'Left_Subarticular_Stenosis_L2_L3', 'confident_of_condition': 0.7354334592819214, 'score_prediction': [array([   0.090543,     0.45113,     0.45833], dtype=float32)]}, {'condition': 'Left_Subarticular_Stenosis_L4_L5', 'confident_of_condition': 0.5536304116249084, 'score_prediction': [array([    0.51177,     0.38141,     0.10682], dtype=float32)]}, {'condition': 'Right_Subarticular_Stenosis_L2_L3', 'confident_of_condition': 0.6072553992271423, 'score_prediction': [array([    0.50544,     0.37714,     0.11742], dtype=float32)]}]}, 'si_44036939_sei_3844393089': {'modality': 'Sagittal_T2/STIR', 'condition': 'Spinal_Canal_Stenosis', 'prediction': [{'condition': 'Spinal_Canal_Stenosis_L4_L5', 'confident_of_condition': 0.42469388246536255, 'score_prediction': [array([   0.035285,     0.34921,     0.61551], dtype=float32)]}, {'condition': 'Spinal_Canal_Stenosis_L3_L4', 'confident_of_condition': 0.375446617603302, 'score_prediction': [array([    0.81695,      0.1638,    0.019253], dtype=float32)]}, {'condition': 'Spinal_Canal_Stenosis_L1_L2', 'confident_of_condition': 0.3923245370388031, 'score_prediction': [array([    0.39757,     0.49234,     0.11009], dtype=float32)]}, {'condition': 'Spinal_Canal_Stenosis_L5_S1', 'confident_of_condition': 0.4563785195350647, 'score_prediction': [array([    0.35786,     0.50576,     0.13638], dtype=float32)]}, {'condition': 'Spinal_Canal_Stenosis_L2_L3', 'confident_of_condition': 0.3390381634235382, 'score_prediction': [array([    0.25183,     0.38235,     0.36582], dtype=float32)]}]}}
...
predictior(test_csv='../Data/test_series_descriptions.csv',test_images='../Data/test_images')
