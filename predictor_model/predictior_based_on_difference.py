...
class predictior:
        ...
        for study_id in list(study_ids_report.keys()):
            ...
            for condition in all_conditions:
                ...
                if len(all_score_predicted_for_this_condition)==0:
                    ...
                    minumin=self.list_with_max_range(all_score_predicted_for_this_condition)

                    study_ids_report[study_id][condition]=minumin
    ...
    def list_with_max_range(self,lists):
        max_range = float('-inf')
        selected_list = None
        for lst in lists:
            current_range = max(lst) - min(lst)  # Calculate range for the current list
